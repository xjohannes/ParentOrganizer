...
import com.axeweb.parentorganizr.repository.ClassListCollectionRepository;
...
public class ClassListController {
    ...
    private final ClassListCollectionRepository repository;

    public ClassListController(ClassListCollectionRepository classListCollectionRepository) {
        this.repository = classListCollectionRepository;
    }
